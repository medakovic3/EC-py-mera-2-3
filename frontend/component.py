...
class Component:
    ...
    def load_hdd(self):
        ...
        self.db_data.hdd = self.municipality_service.get_hdd_by_municipality(
                                                        municipality_name
                                                     )
    ...
    def load_needed_energy(self):
        ...
        self.db_data.needed_energy_per_m2 = self.needed_energy_service.get_needed(
                                        construction_period,
                                        dwelling_type_str
                                    )       
    ...
    def load_insulated_surface_parameters(self):
        ...
        construction_period = self.user_home_info.construction_period.value
        self.db_data.insulated_surface = \
    ...
    def load_heating_fuel_parameters(self):
        ...
        self.db_data.heating_fuel = \
            self.heating_fuel_service.get_heating_fuel_parameters(
                                        heating_fuel_type,
                                        heating_system_type
                                      )
